...
class IncidentsControllerTest < ActionController::TestCase
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post :create, incident: { Descripcion: @incident.Descripcion, Duracion: @incident.Duracion, Evento: @incident.Evento, Fecha: @incident.Fecha, Solucion: @incident.Solucion }
    end
  ...
  test "should update incident" do
    patch :update, id: @incident, incident: { Descripcion: @incident.Descripcion, Duracion: @incident.Duracion, Evento: @incident.Evento, Fecha: @incident.Fecha, Solucion: @incident.Solucion }
    assert_redirected_to incident_path(assigns(:incident))
  end
